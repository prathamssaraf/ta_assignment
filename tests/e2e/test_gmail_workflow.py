...
class TestGmailWorkflow:
    ...
    def mock_gmail_service(self):
        ...
        with patch('gmail_client_impl.os.path.exists') as mock_exists, \
             patch('gmail_client_impl.Credentials.from_authorized_user_file') as mock_creds, \
    ...
    def test_complete_email_workflow(self, mock_gmail_service) -> None:
        ...
        mock_service.users().messages().send.return_value.execute.return_value = {"id": "sent123"}
    ...
    def test_error_handling_workflow(self, mock_gmail_service) -> None:
        ...
        mock_service.users().messages().delete.return_value.execute.side_effect = http_error
