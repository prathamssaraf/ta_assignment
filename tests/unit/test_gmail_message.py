...
class TestGmailMessage:
    ...
    def test_gmail_message_creation(self) -> None:
        ...
        assert "Mon, 15 Jan 2025 10:00:00 +0000" in message.date
    ...
    def test_gmail_message_special_characters(self) -> None:
        ...
        email_content = (
            "From: sender@example.com\r\n"
            "To: recipient@example.com\r\n"
            "Subject: Special chars: àáâã ñ 中文\r\n"
            "\r\n"
            "Body with émojis: 🚀 📧 ✨"
        )
        ...
        assert "Special chars: àáâã ñ 中文" in message.subject
        assert "émojis: 🚀 📧 ✨" in message.body
